            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>Slug</th>
                            <td field-key='slug'>{{ $manufacturer->slug }}</td>
                        </tr>
                        <tr>
                            <th>Logo</th>
                            <td field-key='brand'>@if($manufacturer->brand)<a href="{{ asset(env('UPLOAD_PATH').'/' . $manufacturer->brand) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/' . $manufacturer->brand) }}"/></a>@endif</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.manufacturers.index') }}" class="btn btn-default">Volver</a>
        </div>
    </div>
@stop
