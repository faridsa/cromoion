        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                <li class="dropdown notifications-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" title="Notificaciones">
            ...
            <li><a href="{{ url('/')}}" target="_blank" title="Ver sitio"><i class="fa fa-desktop fa-lg" aria-hidden="true"></i></a></li>
            <li><a href="#logout" onclick="$('#logout').submit();" title="Cerrar sesión"><i class="fa fa-power-off fa-lg" aria-hidden="true"></i></a></li>
