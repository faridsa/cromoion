...
class ContentPagesController extends Controller
{
    ...
    public function create()
    {
        ...
        $category_ids = \App\Models\ContentCategory::get()->pluck('title', 'id');
        $tag_ids = \App\Models\ContentTag::get()->pluck('title', 'id');
    ...
    public function edit($id)
    {
        ...
        $category_ids = \App\Models\ContentCategory::get()->pluck('title', 'id');$tag_ids = \App\Models\ContentTag::get()->pluck('title', 'id');
