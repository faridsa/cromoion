...
class ProductCategoriesController extends Controller
{
   ...
   // ProductCategory::fixTree();
    ...
    public function create()
    {
        ...
        $parent_categories = ProductCategory::with('children')->pluck('name', 'id');

        return view('admin.product_categories.create',compact('parent_categories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.product_categories.edit', compact('product_category','parent_categories'));
    }
